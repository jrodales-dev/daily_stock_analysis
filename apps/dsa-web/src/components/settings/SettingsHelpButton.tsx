...
export const SettingsHelpButton: React.FC<SettingsHelpButtonProps> = ({
  ...
  return (
    <>
      <Tooltip content="Exibir Descrições">
        <span className="inline-flex">
          <button
            ...
            aria-label={`Ver Parâmetro para ${title}`}
            aria-expanded={open}
