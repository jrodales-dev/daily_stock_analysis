...
const MARKET_BADGE_CONFIG = {
  ...
  INDEX: { label: 'Índice', className: 'border-purple/25 bg-purple/10 text-purple' },
...
function MatchTypeBadge({ matchType }: { matchType: string }) {
  const configMap = {
    exact: { label: 'Exato', className: 'border-cyan/25 bg-cyan/10 text-cyan' },
    prefix: { label: 'Prefixo', className: 'border-purple/25 bg-purple/10 text-purple' },
    contains: { label: 'Contém', className: 'border-warning/25 bg-warning/10 text-warning' },
